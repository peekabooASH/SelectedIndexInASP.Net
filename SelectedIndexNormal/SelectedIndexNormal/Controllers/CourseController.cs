...
namespace SelectedIndexNormal.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="CourseId,Code,Name,Credit")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="CourseId,Code,Name,Credit")] Course course)
        {
            if (ModelState.IsValid)
            {
